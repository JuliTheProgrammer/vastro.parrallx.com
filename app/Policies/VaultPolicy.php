...
class VaultPolicy
{
    ...
    {
        // check if user has bought pro subscription to create more than three
        return false;
    }
    ...
    {
        // check if vault has delete protection enabled
        return ! $vault->delete_protection && $user->id === $vault->user_id;
    }
